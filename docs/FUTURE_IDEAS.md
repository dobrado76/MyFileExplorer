...
**Status:** parking lot only. **Do not implement from this file.** These are candidates for later, independent evaluation — not a roadmap, not a batch spec, and not part of current v0.9.0 work.
