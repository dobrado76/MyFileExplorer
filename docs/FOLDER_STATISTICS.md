...
<!-- Drop a real capture here as docs/image/screenshot-folder-statistics.png -->
![Folder statistics preview — summary, Contents, Largest, and Space usage treemap](image/screenshot-folder-statistics.png)

> **Screenshot placeholder** — save a clear example of the folder preview card (summary + Contents + Largest / Recently modified + **Space usage** map) as:
>
> `docs/image/screenshot-folder-statistics.png`
>
> Until that file exists, GitHub will show a broken image above; the rest of this page stands alone.
