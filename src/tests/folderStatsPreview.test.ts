...
describe('classifyFolderStatsExt', () => {
  it('maps common extensions', () => {
    ...
    expect(classifyFolderStatsExt('m2ts')).toBe('videos')
    expect(classifyFolderStatsExt('ts')).toBe('documents')
    expect(classifyFolderStatsExt('ts', 500_000)).toBe('documents')
    expect(classifyFolderStatsExt('ts', 1024 * 1024)).toBe('videos')
    expect(classifyFolderStatsExt('mts', 2_000_000)).toBe('videos')
    expect(classifyFolderStatsExt('tsx')).toBe('documents')
    expect(classifyFolderStatsExt('js')).toBe('documents')
    expect(classifyFolderStatsExt('py')).toBe('documents')
