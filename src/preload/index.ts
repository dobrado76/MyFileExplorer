...
const api: MyFileExplorerApi = {
  ...
  shell: {
    ...
    redirectGetStatus: invokeVoid(IPC.shellRedirectGetStatus),
    redirectEnable: invokeVoid(IPC.shellRedirectEnable),
    redirectDisable: invokeVoid(IPC.shellRedirectDisable),
    redirectRestore: invokeVoid(IPC.shellRedirectRestore),
    redirectRepair: invokeVoid(IPC.shellRedirectRepair),
    redirectTest: invokeVoid(IPC.shellRedirectTest),
    redirectReadInvocations: invoke(IPC.shellRedirectReadInvocations),
    redirectClearInvocations: invokeVoid(IPC.shellRedirectClearInvocations),
  ...
  script: {
    ...
    queueList: invokeVoid(IPC.scriptQueueList),
    queueEnqueue: invoke(IPC.scriptQueueEnqueue),
    queueReorder: invoke(IPC.scriptQueueReorder),
    queueRemove: invoke(IPC.scriptQueueRemove),
    queueClear: invoke(IPC.scriptQueueClear),
    queueUpdate: invoke(IPC.scriptQueueUpdate),
